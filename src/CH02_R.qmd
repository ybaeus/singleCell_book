...
[코드 2-3] BiocManager를 통한 바이오컨덕터 패키지 설치
```{r}
# BiocManager 패키지 설치 및 버전 확인하기
...
```{r}
# 데이터 파일 읽기 
data <- read.csv("data.csv")  # CSV 파일을 읽어 데이터 프레임으로 저장하기
