...
# 08 배치 효과 교정 
```{r}
pbmc_alzheimer_SCT.combined2 <- readRDS("./pbmc_alzheimer_SCT.combinded_2_clustered_2024.rds")
```
...
markers <- FindAllMarkers(pbmc_alzheimer_SCT.combined , only.pos = TRUE) # only positive for now 47401     7
