...
[코드 5 - 2] 모든 샘플을 Seurat 오브젝트 변형하기
```{r}
...
# Chapter 06 "정규화 및 배치 교정" + 07 "차원 축소 및 클러스터링" 
...
# saveRDS(pbmc_alzheimer_SCT.combined, "./rds/pbmc_alzheimer_1_SCT.rds")
```
...
pbmc_alzheimer_2_SCT <- SCTransform(pbmc_alzheimer_2, verbose = FALSE) %>% # 메모리가 부족하면 (64GB 미만) 터질 수 있습니다.
                            RunPCA(npcs = 30, verbose = FALSE) %>%
...
DimPlot(pbmc_alzheimer_2_SCT, reduction = "umap")
