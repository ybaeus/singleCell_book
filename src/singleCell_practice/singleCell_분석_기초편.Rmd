...
```{r}
pbmc_alzheimer_SCT.combined <- readRDS("./rds/pbmc_alzheimer_SCT.combinded_2.rds") # percent.mt < 10, min.cell, min.feature, vars.to.regress = "percent.mt", 적용 ## # pbmc_alzheimer_SCT.combinded_1.rds 은 percent.mt < 5, 나머지 적용 안함
```
